...
import { ChevronDown, ChevronRight, AlertCircle, Save, FileText, Check } from "lucide-react";
import { updateSitePage, type ActionResult } from "@/app/admin/_actions/pages";
import { ContentEditorShell } from "@/components/admin/content-editor";
...
export default function PagesView({ pages }: { pages: SitePage[] }) {
  ...
  return (
    <ContentEditorShell
      active="pages"
      title="Pages"
      description="Per-page SEO, hero overrides, and visibility. Changes update the live site."
    >
      {pages.length === 0 ? (
