...
// Login-screen branding. Self-contained on purpose — no data/* import for
// the build agent to chase (the old mock-hotel import forced every build to
// create a hotel-named stub). The build tailors businessName + theme to the
// site; the defaults below are neutral and render fine untouched.
const config = {
  businessName: "Lane Proof Atelier",
...
export default function AdminLoginPage() {
  ...
  return (
    ...
    >
      {/* Left — Hero image (desktop only). Falls back to a brand gradient
          when no image is configured — never an empty <img src="">. */}
      <div className="hidden lg:block lg:w-1/2 relative bg-gray-900">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-black/70 via-[var(--color-primary)]/40 to-black/70" />
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-3.5 rounded-xl border border-gray-200 bg-white text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 text-sm transition-all"
                      />
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-12 py-3.5 rounded-xl border border-gray-200 bg-white text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 text-sm transition-all"
                      />
                      <button
                        type="button"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) => setEmail(e.target.value)}
                      placeholder="admin@yourbusiness.com"
                      className="w-full pl-10 pr-4 py-3.5 rounded-xl border border-gray-200 bg-white text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 text-sm"
                    />
                  </div>
                </div>
